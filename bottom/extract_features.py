...
class features():
    ...
    def __init__(self, raw_image, NUM_OBJECTS=36):
    ...
    def doit(self):
        ...
        with torch.no_grad():
            ...
            # Preprocessing
            image = predictor.transform_gen.get_transform(self.raw_image).apply_image(self.raw_image)
